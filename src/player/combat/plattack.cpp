...
void plattack::Update(float dt, Vector2 playerPos, Rectangle playerSize) {
    ...
    if (rotation == 0) { // Rechts
        ...
        hitBox = { attackStart.x, attackStart.y - 20.0f, 70.0f, 40.0f };
    }
        ...
        hitBox = { attackStart.x - 70.0f, attackStart.y - 20.0f, 70.0f, 40.0f };
    }
